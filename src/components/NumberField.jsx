...
export default class NumberField extends Component {
   ...
   render() {
      return (
         <div>
            <label style={{ width: '58px', display: 'inline-block' }}>{this.props.label}:</label>
            <input onMouseDown={this.mouseDown} onChange={this.changeProp} value={this.state.value} type="number" />
         </div>
      );
   }
}
